...
#this line will bypass the config screen
...
#this line echo the password for ldap server to /etc/ldap.secret
echo "ofpcxswW" > /etc/ldap.secret
...
#this 3 lines will edited the lines in /etc/ldap.conf
